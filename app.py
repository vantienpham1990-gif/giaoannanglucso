...
<div class="main-header">
    ...
    <p>Tác giả: Phạm Văn Tiến - Trường Tiểu học Hùng An - ĐT: 0328851139</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phạm Văn Tiến - Trường Tiểu học Hùng An - ĐT: 0328851139</div>", unsafe_allow_html=True)
